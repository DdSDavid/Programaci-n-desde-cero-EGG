...
Algoritmo ejercicio6
	...
	rellenarMatriz(matriz, tamanio)// Llenamos la matriz
	
	Escribir ""
	mostrarMatriz(matriz, tamanio)// Mostramos el contenido de la matriz
	
	Escribir ""
	sumarValoresMatriz(matriz, tamanio)// Llamada al SubProceso  para realizar la suma
